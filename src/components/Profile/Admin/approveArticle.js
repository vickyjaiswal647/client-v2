    ...
    return (
        <form onSubmit = {handleSubmit} className = "Parent">
            ...
            <div className = "button">
                ...
                <Button type = "submit" className = "buttons" variant="contained" color="success" onClick = {handleApprove}>
                    Approve
                </Button>
                <Button type = "submit" className = "buttons" variant="outlined" color="error" onClick = {handleDecline}>
                    Decline
                </Button>
            </div>
        </form>
